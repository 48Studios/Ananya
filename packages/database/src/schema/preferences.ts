...
export const userWorkspacePreferences = pgTable(
  "user_workspace_preferences",
  {
    ...
    userId: uuid("user_id")
      ...
      .unique()
      .references(() => users.id, { onDelete: "cascade" }),
    defaultLandingPage: varchar("default_landing_page", { length: 255 })
      .notNull()
      .default("/dashboard"),
    tableDensity: varchar("table_density", { length: 32 })
      .notNull()
      .default("compact"), // 'compact' | 'comfortable'
    themePreference: varchar("theme_preference", { length: 32 })
      .notNull()
      .default("system"),
    updatedAt: timestamp("updated_at", { withTimezone: true })
      .notNull()
...
export type UserDashboardLayoutRecord =
  typeof userDashboardLayouts.$inferSelect;
...
export type UserWorkspacePreferenceRecord =
  typeof userWorkspacePreferences.$inferSelect;
