...
export const inventoryReservations = pgTable(
  ...
  (table) => [
    uniqueIndex('inventory_reservations_number_unique').on(table.reservationNumber),
...
export const inventoryReservationLines = pgTable(
  'inventory_reservation_lines',
  {
    ...
    reservedQuantity: decimal('reserved_quantity', { precision: 12, scale: 4 })
      .notNull()
      .default('0.0000'),
    fulfilledQuantity: decimal('fulfilled_quantity', { precision: 12, scale: 4 })
      .notNull()
      .default('0.0000'),
  ...
  (table) => [
    index('inventory_reservation_lines_reservation_id_idx').on(table.reservationId),
...
export type InventoryReservationRecord = typeof inventoryReservations.$inferSelect;
export type NewInventoryReservationRecord = typeof inventoryReservations.$inferInsert;
export type InventoryReservationLineRecord = typeof inventoryReservationLines.$inferSelect;
export type NewInventoryReservationLineRecord = typeof inventoryReservationLines.$inferInsert;
