...
export const workOrdersApi = {
  ...
  getMaterialRequirements: (
    id: string,
  ): Promise<MaterialRequirementDetailDto[]> =>
    apiClient.get<MaterialRequirementDetailDto[]>(
  ...
  create: (payload: CreateWorkOrderPayload): Promise<WorkOrderDto> =>
    apiClient.post<WorkOrderDto, CreateWorkOrderPayload>(
      "/work-orders",
      payload,
    ),
  update: (
    ...
    apiClient.put<WorkOrderDto, UpdateWorkOrderPayload>(
      `/work-orders/${id}`,
      payload,
    ),
  release: (id: string): Promise<WorkOrderDto> =>
    apiClient.post<WorkOrderDto, Record<string, never>>(
  ...
  recordPartialOutput: (
    id: string,
    payload: RecordPartialOutputPayload,
  ): Promise<WorkOrderDto> =>
    apiClient.post<WorkOrderDto, RecordPartialOutputPayload>(
      `/work-orders/${id}/record-output`,
      payload,
    ),
  recordScrap: (
    id: string,
    payload: RecordScrapPayload,
  ): Promise<WorkOrderDto> =>
    apiClient.post<WorkOrderDto, RecordScrapPayload>(
  ...
  complete: (id: string, producedQuantity?: number): Promise<WorkOrderDto> =>
    apiClient.post<WorkOrderDto, { producedQuantity?: number }>(
