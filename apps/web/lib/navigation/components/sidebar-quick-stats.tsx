            ...
            setStats([
              {
                id: "inv-skus",
                label: "Total SKUs",
                value: res.totalComponents,
              },
              {
                id: "inv-resv",
                label: "Reserved Stock",
                value: res.reservedQuantity,
              },
            ]);
          }
            ...
            setStats([
              {
                ...
                value: res.totalPurchaseOrders,
              },
              {
                id: "proc-rec",
                label: "Goods Receipts",
                value: res.totalGoodsReceipts,
              },
            ]);
          }
