...
const mockReturns: CustomerReturnRecord[] = [
  { id: 'cret-1', returnNumber: 'CR-2026-011', customerName: 'AeroTech Systems', reason: 'Packaging damaged during transit', status: 'INSPECTED', returnDate: '2026-02-02' },
]
  ...
  const columns: ColumnDef<CustomerReturnRecord>[] = [
    {
      ...
      header: 'Return No.',
      cell: ({ row }) => (
        <Link href={`/customer-returns/${row.original.id}`} className="font-mono text-xs font-bold text-primary hover:underline">
