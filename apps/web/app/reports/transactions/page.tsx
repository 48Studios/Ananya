...
export default function TransactionReportsPage() {
  const [summary, setSummary] = React.useState<TransactionSummaryDto | null>(
    null,
  );
    ...
    try {
      ...
      setError(
        err instanceof Error
          ? err.message
          : "Failed to load transaction audit report",
      );
    } finally {
      setLoading(false);
    }
  ...
  const txTypeDonutData = [
    ...
    {
      name: "Adjustments",
      value: summary.adjustmentCount ?? 0,
      color: "#f59e0b",
    },
  ];
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <StatCard
          ...
          value={formatNumber(
            (summary.transferCount ?? 0) + (summary.adjustmentCount ?? 0),
          )}
