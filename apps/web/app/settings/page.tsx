    ...
    <PermissionGuard permission="Administration.Settings">
      <div className="space-y-6">
        <PageHeader
          ...
          description="Configure enterprise organization profile, system defaults, numbering series, data packs, and danger zone."
        />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <Field>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setSystem({ ...system, baseCurrency: e.target.value })
                      }
                      className="font-mono"
                    />
                  </Field>
