...
import { Edit3, Trash2, ArrowLeft, Building2, ShoppingBag, Package, Star, Mail, Phone, CheckCircle2 } from 'lucide-react'
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-2 bg-card border border-border rounded-xl p-6 space-y-6 shadow-xs">
          ...
          <dl className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-4 text-sm">
            <div>
              <dt className="text-xs font-medium text-muted-foreground">Supplier ID</dt>
            ...
            <div>
              <dt className="text-xs font-medium text-muted-foreground">Supplier Code</dt>
            ...
            <div>
              ...
              <dd className="mt-1 text-sm font-medium text-foreground">{supplier.name}</dd>
            </div>

            <div>
              <dt className="text-xs font-medium text-muted-foreground">Tax ID / GST</dt>
          ...
          <div className="pt-4 border-t border-border flex items-center justify-between text-xs text-muted-foreground">
            <span>Created: {new Date(supplier.createdAt).toLocaleString()}</span>
            <span>Updated: {new Date(supplier.updatedAt).toLocaleString()}</span>
          </div>
        </div>
          ...
          {contactsList.length > 0 ? (
            <div className="space-y-3">
              {contactsList.map((contact) => (
                <div key={contact.id} className="p-3 bg-muted/30 border border-border rounded-lg space-y-1">
                  <div className="flex items-center justify-between">
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-xs text-muted-foreground">
                    Lead Time: {cp.leadTimeDays} days | MOQ: {cp.minimumOrderQuantity}
                  </span>
                </div>
