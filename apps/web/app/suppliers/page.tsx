...
import { Plus, X, Eye, Edit3, Trash2, Building2, CheckCircle2, AlertCircle, RefreshCw } from 'lucide-react'
...
export default function SuppliersPage() {
  ...
  const [deletingSupplier, setDeletingSupplier] = React.useState<SupplierDto | null>(null)
  ...
  const handleDeleteConfirm = async () => {
    ...
    try {
      ...
      setToastMessage(`Supplier "${deletingSupplier.code}" deleted successfully.`)
