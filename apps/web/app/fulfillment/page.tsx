...
export default function FulfillmentPage() {
  ...
  const columns: ColumnDef<FulfillmentShipment>[] = [
    ...
    },
    {
      ...
      cell: ({ row }) => <span className="font-mono text-xs text-foreground font-medium">{row.original.soNumber}</span>,
    },
    {
    ...
    },
    {
      ...
      cell: ({ row }) => (
        <div>
          <p className="text-xs font-semibold text-foreground">{row.original.carrier}</p>
          <p className="font-mono text-[11px] text-muted-foreground">{row.original.trackingNumber}</p>
        </div>
      ),
    },
    {
    ...
    },
    {
      ...
      cell: ({ row }) => <span className="text-xs text-muted-foreground">{formatDate(row.original.dispatchDate)}</span>,
    },
  ]
