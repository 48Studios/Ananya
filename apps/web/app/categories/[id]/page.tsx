...
import { Edit3, Trash2, ArrowLeft, FolderTree, Package, Layers, CheckCircle2 } from 'lucide-react'
...
export default function ViewCategoryPage() {
  ...
  const [parentCategory, setParentCategory] = React.useState<CategoryDto | null>(null)
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-2 bg-card border border-border rounded-xl p-6 space-y-6 shadow-xs">
          ...
          <dl className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-4 text-sm">
            <div>
              <dt className="text-xs font-medium text-muted-foreground">Category ID</dt>
            ...
            <div>
              ...
              <dd className="mt-1 text-sm font-medium text-foreground">{category.name}</dd>
            </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-card border border-border rounded-xl p-6 space-y-4 shadow-xs">
            <div className="flex items-center justify-between">
              <h3 className="text-base font-semibold text-foreground">Parent Category</h3>
            ...
            {parentCategory ? (
              <div className="p-3 bg-muted/30 border border-border rounded-lg space-y-1">
                ...
                <p className="text-sm font-medium text-foreground">{parentCategory.name}</p>
