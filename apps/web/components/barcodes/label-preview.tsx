      ...
      >
        ...
        <div className="flex items-center justify-between gap-4">
          <div className="space-y-1">
            ...
            <p className="text-xs font-medium text-slate-600">{label.subtitle}</p>
          </div>
          <QRCodeViewer value={label.qrPayload} size={70} className="p-1 border-0" />
        </div>
      </div>
    )
  }
    ...
    return (
      ...
      >
        <div className="flex items-start justify-between gap-2 border-b border-slate-200 pb-2">
          ...
          <QRCodeViewer value={label.qrPayload} size={64} className="p-1 border-0" />
        </div>

        <div className="flex flex-col items-center justify-center pt-1">
          <BarcodeViewer value={label.primaryCode} format={format} height={55} showText />
        </div>
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between gap-3">
        ...
        <QRCodeViewer value={label.qrPayload} size={56} className="p-1 border-0" />
      </div>

      <div className="flex flex-col items-center justify-center pt-1 border-t border-slate-200">
        <BarcodeViewer value={label.primaryCode} format={format} height={45} showText />
      </div>
    </div>
  )
}
