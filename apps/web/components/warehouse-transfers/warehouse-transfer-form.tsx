  ...
  const {
    ...
    defaultValues: initialData
      ...
      : {
          ...
          notes: '',
          lines: [{ componentId: '', quantity: 10, unitOfMeasure: 'pcs', notes: '' }],
        },
  })
  ...
  const onSubmit: SubmitHandler<WarehouseTransferFormValues> = async (values) => {
    ...
    try {
      if (isEdit && initialData) {
        ...
        const updated = await warehouseTransfersApi.update(initialData.id, payload)
        onSuccess(updated)
      } else {
      ...
      <div className="space-y-2 pt-2 border-t border-border">
        <div className="flex items-center justify-between">
          ...
          <Button
            ...
            size="xs"
            onClick={() =>
              append({ componentId: '', quantity: 1, unitOfMeasure: 'pcs', notes: '' })
            }
          >
