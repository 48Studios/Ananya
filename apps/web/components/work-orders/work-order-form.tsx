...
const workOrderSchema = z.object({
  ...
  quantityPlanned: z
    .number()
    .min(1, "Planned quantity must be at least 1 unit"),
...
export function WorkOrderForm({
  ...
  const [availableBoms, setAvailableBoms] = React.useState<
    BillOfMaterialsDto[]
  >([]);
