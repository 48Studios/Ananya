...
export function ComponentReviewQueueDialog({
  ...
  React.useEffect(() => {
    setPageNumber(1);
  }, [statusFilter, categoryFilter, issueTypeFilter, confidenceFilter]);
        ...
        <DialogShellBody scrollable={false}>
          ...
          {loading && !page ? (
            ...
            <>
              ...
              <div className="flex shrink-0 flex-col items-center justify-between gap-2 px-1 text-[11px] text-muted-foreground sm:flex-row">
                <span>
                  Page{" "}
                  ...
                  finding{(page?.total ?? 0) === 1 ? "" : "s"} matching filters
                </span>
